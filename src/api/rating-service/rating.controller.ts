...
import { MyRatingOutput, RatingStatsOutput, RatingsOutput, UpdateRatingRecord } from "../../types/rating";
import { putRatingHandler } from "./rating.model.put";
...
export class RatingController extends Controller {
	...
	public async putRating(
		...
		@Body() rating: UpdateRatingRecord,
		@Res() unauthorizedCallback: TsoaResponse<403, { reason: string }>,
	): Promise<RatingsOutput | string> {
		return putRatingHandler(authorization, rating_id, rating, unauthorizedCallback);
	}
}
