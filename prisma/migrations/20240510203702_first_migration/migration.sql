...
-- CreateTable
CREATE TABLE "restaurant"."restaurant_stadistics" (
...
-- CreateIndex
CREATE UNIQUE INDEX "restaurant_stadistics_restaurant_id_key" ON "restaurant"."restaurant_stadistics"("restaurant_id");
...
-- AddForeignKey
ALTER TABLE "restaurant"."restaurant_stadistics" ADD CONSTRAINT "restaurant_stadistics_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"."restaurants"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
